const Status = () => {
  return (
    <div className="row justify-content-center" style={{paddingTop: "70px"}}>
      <div
        className="status-component bg-light shadow-sm rounded-2 col-12"
        style={{width: "100%", maxWidth: "562.4px", padding: "12px 16px"}}
      >
        <div className="status-component-above d-flex">
          <div className="status-component-avatar">
            <img
          ...
          <div className="status-component-bar flex-fill ms-2 bg-secondary bg-opacity-10 btn rounded-5">
        ...
        <div className="status-component-bellow row">
